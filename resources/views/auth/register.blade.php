...
@section('title', trans('auth.join_us'))
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">{{ trans('auth.join_us') }}</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('institute') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">{{ trans('auth.institute') }}</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i>{{ trans('auth.join_us') }}
                                </button>
                            </div>
                        </div>
                    </form>
